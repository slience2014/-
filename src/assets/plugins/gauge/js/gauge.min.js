...
browserRequestAnimationFrame=null;lastId=0;isCancelled={};
if(!requestAnimationFrame){
	window.requestAnimationFrame=function(
		callback,element){
		var currTime,id,lastTime,timeToCall;currTime=new Date().getTime();
	...
	String.prototype.hashCode=function(){
		...
		hash,i,_i,_ref;hash=0;
		if(this.length===0){return hash;}
for(i=_i=0,_ref=this.length;0<=_ref?_i<_ref:_i>_ref;i=0<=_ref?++_i:--_i){
	charS=this.charCodeAt(i);hash=((hash<<5)-hash)+charS;hash=hash&hash;}
return hash;};
